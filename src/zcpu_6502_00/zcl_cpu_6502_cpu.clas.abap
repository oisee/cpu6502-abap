CLASS zcl_cpu_6502_cpu DEFINITION
  PUBLIC
  CREATE PUBLIC.
************************************************************************
* 6502 CPU Emulator
...
************************************************************************
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING io_bus TYPE REF TO zif_cpu_6502_bus.
  ...
  PRIVATE SECTION.
    DATA mo_bus TYPE REF TO zif_cpu_6502_bus.
...
CLASS ZCL_CPU_6502_CPU IMPLEMENTATION.
